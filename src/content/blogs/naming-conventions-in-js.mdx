...
coverAlt: "JavaScript naming conventions cheat sheet illustration"
tags: ["javaScript"]
description: "Practical JavaScript naming conventions from Crockford's How JavaScript Works — variables, constants, functions, and classes the right way."
keywords: ["javascript naming conventions", "javascript variable naming", "clean javascript code", "douglas crockford javascript", "javascript style guide"]
---
...
<Note type="tip" title="Important Information">
  About Douglas Crockford, is a software engineer best known for discovering and
  standardizing JSON, authoring “JavaScript: The Good Parts”, and shaping modern
  JavaScript practices. He has worked at Yahoo!, PayPal, and was a key voice in
  the ECMA TC39 standards committee.
</Note>
