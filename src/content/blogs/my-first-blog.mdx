---
title: "Remix Forms: Better UX and DX with Native Form Handling"
...
cover: ../featured_svgs/cover-1.svg
coverAlt: "Remix framework form handling diagram"
tags: ["remix"]
description: "How Remix forms beat React's controlled-input model — progressive enhancement, no extra state libraries, and a better UX/DX out of the box."
keywords: ["remix forms", "remix form handling", "remix vs react forms", "progressive enhancement forms", "remix action loader"]
---
