---
title: "How JavaScript Stores Numbers in Memory (IEEE 754 Explained)"
subheading: "A peek under the hood at the 64-bit floating point format JavaScript uses for every number, and why that shapes precision, range, and quirks."
slug: "how-javascript-stores-numbers"
publishedAt: 2025-09-20
readingTimeInMins: 5
cover: ../featured_svgs/how-js-stores-numbers-in-memory.svg
coverAlt: "IEEE 754 double-precision floating point bit layout used by JavaScript"
tags: ["javaScript"]
description: "How JavaScript stores every number as a 64-bit IEEE 754 double — sign, exponent, mantissa — and what that means for precision."
keywords: ["how javascript stores numbers", "IEEE 754", "javascript floating point", "64 bit double precision", "javascript number memory"]
---
...
- **JS** uses **64 bit double precision floating point numbers**. (_if this feels verbose, i will explain it to you exactly what it means_)
...
<Note type="tip" title="Important Information">
  ...
  Single precision (32 bits) has 23 mantissa bits, while double precision has 52
  mantissa bits, giving 29 extra bits. The extra bits allow for a more accurate
...
- **52 bits → Fraction (Mantissa)**
  ...
  - For _normalized numbers_, an **implicit leading `1`** is added in front
