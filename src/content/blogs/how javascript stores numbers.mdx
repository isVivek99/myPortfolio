---
title: "How JavaScript stores numbers"
...
Hello folks! I'm back with another blog. This time we're going to talk about how javaScript stores numbers in memory.

JavaScript is a very quirky language, a lot of things javascript has or does have been borrowed from existing languages or 
...
console.log(03 === 0.1 + 0.2) // returns false

console.log(100/3) // returns 33.333333333333336 and not 33.33333333333333
...
```js
0.1  = 0.0001100110011001100110011001100… (binary, repeating)
0.2  = 0.0011001100110011001100110011001… (binary, repeating)
Sum  = 0.010011001100110011001100110011… (binary)
```
when we convert it back to decimal we get the value as 
