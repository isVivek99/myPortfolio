...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, f as escape, g as renderUniqueStylesheet, h as renderScriptElement, i as createHeadAndContent, r as renderComponent } from './astro/server_QlrBW5xk.mjs';
import { r as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_C-ZOwaTP.mjs';
import { V as VALID_INPUT_FORMATS } from './_astro_assets_B0-JMAFI.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_zvctE0gs.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_Lo7R-q0t.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_B0-JMAFI.mjs').then(n => n._);
...
const myGradient = new Proxy({"src":"/_astro/myGradient.QSScO5Tz.jpeg","width":3840,"height":2560,"format":"jpg"}, {
...
export { formatDate as f, getCollection as g, myGradient as m };
